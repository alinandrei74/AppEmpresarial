      ...
      <table className='tableManagement'>
        <thead className='theadManagement'>
          <tr className='trManagement'>
            <th className='thManagement'>Usuario</th>
            <th className='thManagement'>Rol</th>
            <th className='thManagement'>Email</th>
            <th className='thManagement'>Fecha de Creación</th>
            <th className='thManagement'>Acciones</th>
          </tr>
        </thead>
        <tbody className='tbodyManagement'>
          {filteredUsers.map(user => (
            <tr key={user.id} className='trManagement'>
              <td className='thManagement'>{`${user.name} ${user.firstname} ${user.lastname} (${user.username})`}</td>
              <td className='thManagement'>{user.role}</td>
              <td className='thManagement'>{user.email}</td>
              <td className='thManagement'>{formatDate(user.created_at)}</td>
              <td className='thManagement'>
                <button 
